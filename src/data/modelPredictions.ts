...
export const predictionModelMeta: PredictionModelMeta = {
  ...
  "rawValidationAccuracy": 0.5809,
  "drawCalibrationThreshold": 0.41,
  "knockoutValidationAccuracy": 0.68,
  "knockoutValidationMatches": 25,
  "knockoutValidationCorrect": 17,
  ...
  "notes": "Classifier trained on 49215 historical matches with exponential time decay and final-tournament matches weighted highest. The match model now uses 25 features, including multiple recent-form windows, Elo level and expected score, opponent strength, team experience, match type, and recency weight. Candidate validation scores: Logistic Regression Baseline: 0.561, HistGradientBoostingClassifier: 0.575, RandomForestClassifier: 0.581, Soft Voting Ensemble (RF + HGB): 0.578. Profiles blend current tournament evidence, availability, tactical fit, cohesion, and coach adaptability. Baseline accuracy: 0.561; raw selected accuracy: 0.581; draw-calibrated accuracy: 0.581 at threshold 0.41. Strict current-knockout backtest: 17/25 correct (0.680). Context scores are analyst estimates and should be refreshed as news changes."
};
