...
export const defaultBracketRounds: BracketRound[] = [
  {
    ...
    matches: [
      ...
      match("r32-2", "round-32", "Round of 32", 74, slot("r32-2-a", "Winner Group E", "germany", "E"), slot("r32-2-b", "Best 3rd Group D", "paraguay", "D", ["A", "B", "C", "D", "F"]), "r16-2", "slotA"),
      ...
      match("r32-5", "round-32", "Round of 32", 77, slot("r32-5-a", "Winner Group I", "france", "I"), slot("r32-5-b", "Best 3rd Group F", "sweden", "F", ["C", "D", "F", "G", "H"]), "r16-2", "slotB"),
      ...
      match("r32-7", "round-32", "Round of 32", 79, slot("r32-7-a", "Winner Group A", "mexico", "A"), slot("r32-7-b", "Best 3rd Group C", "scotland", "C", ["C", "E", "F", "H", "I"]), "r16-4", "slotA"),
      match("r32-8", "round-32", "Round of 32", 80, slot("r32-8-a", "Winner Group L", "england", "L"), slot("r32-8-b", "Best 3rd Group I", "senegal", "I", ["E", "H", "I", "J", "K"]), "r16-4", "slotB"),
      match("r32-9", "round-32", "Round of 32", 81, slot("r32-9-a", "Winner Group D", "usa", "D"), slot("r32-9-b", "Best 3rd Group B", "bosnia-herzegovina", "B", ["B", "E", "F", "I", "J"]), "r16-6", "slotA"),
      match("r32-10", "round-32", "Round of 32", 82, slot("r32-10-a", "Winner Group G", "egypt", "G"), slot("r32-10-b", "Best 3rd Group J", "algeria", "J", ["A", "E", "H", "I", "J"]), "r16-6", "slotB"),
      ...
      match("r32-13", "round-32", "Round of 32", 85, slot("r32-13-a", "Winner Group B", "canada", "B"), slot("r32-13-b", "Best 3rd Group G", "iran", "G", ["E", "F", "G", "I", "J"]), "r16-8", "slotA"),
      ...
      match("r32-15", "round-32", "Round of 32", 87, slot("r32-15-a", "Winner Group K", "colombia", "K"), slot("r32-15-b", "Best 3rd Group L", "ghana", "L", ["D", "E", "I", "J", "L"]), "r16-8", "slotB"),
